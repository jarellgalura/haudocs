...
const Initialtab = (props) => {
    ...
    const columns = [
        ...
        { field: "name", headerName: "Sent By", width: "175" },
        {
            ...
            width: "200",
            renderCell: (params) => (
                <span>{params.value ? "Forwarded" : ""}</span>
            ),
        },
                    ...
                    <Box required sx={{ display: "flex", gap: "1rem" }}>
                        <FormControl sx={{ width: "100%" }}>
                            ...
                            >
                                ...
                                <MenuItem value="Expedited Review">
                                    Expedited Review
                                </MenuItem>
                            </Select>
                        </FormControl>
                    ...
                    <Box required sx={{ display: "flex", gap: "1rem" }}>
                        <FormControl sx={{ width: "100%" }}>
                            ...
                            >
                                ...
                                <MenuItem value="Clinical Trials">
                                    Clinical Trials
                                </MenuItem>
                                <MenuItem value="Public Health Research">
                                    Public Health Research
                                </MenuItem>
                                <MenuItem value="Social Research">
                                    Social Research
                                </MenuItem>
                            </Select>
                        </FormControl>
